-- =============================================================================
-- V5__replace_dev_seed.sql
-- Replaces the minimal V2 seed data with comprehensive dev data.
-- This migration runs once on the next application startup.
-- For subsequent resets, use scripts/seed_dev_data.sql.
-- =============================================================================
...
-- ASSIGNMENTS
-- =============================================================================
-- One ACTIVE assignment per employee max (enforced by partial unique index).
--
-- Current state (2026-03-16):
--   Erik   → Spotify   ACTIVE  ends 2026-08-31
--   Sara   → Klarna    ACTIVE  ends 2026-02-28  (renewal in progress)
--   Johan  → IKEA      ACTIVE  ends 2026-04-01  ← ENDING_SOON
...
VALUES
    ...
    -- Johan @ IKEA (active, ending within 30 days → ENDING_SOON in UI)
...
VALUES
    ('00000000-0000-0000-0007-000000000001',
     ...
     'We built this platform to make everyday work easier for everyone at Netler. Use it to manage your profile and bank details, submit vacation requests, follow client assignments, and stay up to date with company news and events. Explore the sections in the menu and let us know if you have feedback or ideas.',
    ...
    ('00000000-0000-0000-0007-000000000003',
     ...
     'We are off to a strong start in 2026. Revenue is up 24% compared to Q1 last year, and we have grown the team by three new consultants. All six consultants are on active assignments or in final negotiations for their next placement. Client satisfaction scores are at an all-time high across all accounts. The full Q1 report is available in the shared drive.',
    ...
    ('00000000-0000-0000-0007-000000000004',
     ...
     'A heads-up that Johan Petersson''s current assignment at IKEA Digital concludes on April 1st. Johan has done great work building out their Design System and Component Library. We are actively in conversations with several clients about Johan''s next placement. If you have any leads, reach out to Marcus directly.',
    ...
    ('00000000-0000-0000-0007-000000000005',
     ...
     'We are planning an amazing summer party this year. Block off the last Friday in June — more details to follow on location and activities.',
...
VALUES
    ('00000000-0000-0000-0008-000000000001',
     ...
     'Knowledge-sharing session on how to use AI coding tools effectively in consulting work. Presented by Erik Lindqvist and Anna Johansson. Bring questions — this will be interactive.',
    ...
    ('00000000-0000-0000-0008-000000000004',
     'Summer Party 2026',
     'Annual Netler summer party! Food, drinks, and outdoor activities. Partners welcome. Exact programme to be announced closer to the date.',
